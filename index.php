<?php
    ...
    if ($_GET['city']) {
     ...
     $urlContents = file_get_contents("http://api.openweathermap.org/data/2.5/weather?q=".urlencode($_GET['city']).",uk&APPID=b453ac50fb6f74cf315d9ea377f4648c");
...
<html lang="en">
  ...
  <fieldset class="form-group">
    <label for="city">Enter the name of your location.</label>
